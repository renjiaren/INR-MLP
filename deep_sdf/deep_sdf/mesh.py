...
def create_mesh(decoder, latent_vec, filename, N=256, max_batch=32 ** 3,epoch=2000):
    start = time.time()
...
def convert_sdf_samples_to_ply(
    ...
    verts, faces, normals, values = skimage.measure.marching_cubes(
        numpy_3d_sdf_tensor, level=0.0, spacing=[voxel_size] * 3, method='lewiner'  #####LEVEL = 0
    )
